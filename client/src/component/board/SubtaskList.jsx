    ...
    <div>
      <ul className="space-y-2">
        {subtasks.map(subtask => (
          <li key={subtask.id} className="flex items-center group">
            <button
              type="button"
              className={`w-5 h-5 rounded-full border ${subtask.completed ? 'bg-blue-500 border-blue-500 text-white' : 'border-gray-300 hover:border-blue-400'} flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 !mr-3 transition-colors`}
      ...
      {!isAddingSubtask ? (
        <button
          ...
          className="flex items-center text-blue-600 hover:text-blue-800 !mt-4 text-sm"
          type="button"
        >
